...
// Faktivo signature: every Button is a full-radius pill (Titan/Mercury shared rule).
// Generous horizontal padding (1.5x vertical) keeps pills feeling decisive, not squished.
// Inside button-group containers, pills relax back to rounded-lg so groups read as one unit.
