    ...
    <div className="bg-muted/20 relative min-h-dvh overflow-hidden">
      ...
      <div className="relative mx-auto grid min-h-dvh max-w-md place-items-center px-6 py-10">
        <div className="bg-card/80 w-full rounded-3xl border p-8 shadow-xl backdrop-blur-sm">
          ...
          {/*
            LoginForm hat 3 modes (signin/signup/magic) — der Tabs-Switcher
            innerhalb des Forms erlaubt dem User, zwischen Anmeldung und
            Registrierung zu wechseln. Wir setzen den Default-Mode auf
            "signup" über CSS/JS. Aktuell wechselt der Form-Tab clientseitig
            — hier zeigen wir das Form an, der Tab-Switch passiert oben.
          */}
          <LoginForm />
